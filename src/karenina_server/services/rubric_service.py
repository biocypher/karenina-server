...
class RubricService:
    ...
    def get_current_rubric(self) -> Rubric | None:
        """Get the current rubric in a thread-safe manner."""
        with self._lock:
            return self._rubric

    def set_current_rubric(self, rubric: Rubric | None) -> None:
    ...
    def has_any_rubric(self, finished_templates: list[Any] | None = None) -> bool:
        """
